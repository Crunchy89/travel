...
class Paket_model extends CI_Model
{
    ...
    {
        $this->table = 'tour';
        $this->nama_id = 'id_tour';
        $this->column_order = array(null, 'nama_tour', 'gambar');
        $this->column_search = array('nama_tour');
        $this->order = array('id_tour' => 'desc');
    }
    ...
    function tambah()
    {
        ...
        $data = [
            'nama_tour' => htmlspecialchars($this->input->post('nama')),
            'gambar' => $upload
        ];
